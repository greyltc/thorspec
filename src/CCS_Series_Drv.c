...
static ViStatus CCSseries_query(ViSession instr, ViBuf cmdBuf, ViUInt32 cmdLen, ViBuf rspBuf, ViUInt32 rspLen);
static ViStatus CCSseries_write(ViSession instr, ViBuf cmdBuf, ViUInt32 cmdLen);
